<table id="example" class="table table-striped table-bordered" style="width:100%">
    ...
    <tbody>
        ...
        if ($sql->rowCount() > 0) {
            foreach ($res1 as $row) {
                $jenkel = ($row['jenis_kelamin'] == 'L') ? 'Laki-Laki' : 'Perempuan';
        ?>
            <tr>
                <td><?php echo $no++; ?></td>
                ...
                <td>
                    <button id="<?php echo $row['id']; ?>" class="btn btn-success btn-sm edit_data"> 
                        <i class="fa fa-edit"></i> Edit 
                    </button>
                    
                    <button id="<?php echo $row['id']; ?>" class="btn btn-danger btn-sm hapus_data"> 
